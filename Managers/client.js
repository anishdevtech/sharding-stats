...
class Client {
    ...
    _validateOptions() {
        ...
        if (!this.config.stats_uri || typeof this.config.stats_uri !== "string" || this.config.stats_uri.includes('http://localhost')) throw new Error("Pls provide your base stats_uri, make sure to use ip  if you are using localhost  e.g:  http//example.com or http:192.168.0.1:3333");
